                    ...
                    <table id="example" class="table data-table table-hover table-bordered table-h text-center">
                        ...
                        @foreach($services as $service)
                            <tr>
                                ...
                                <td>
                                    <img src="{{secure_asset('assets/img/'.$service->image)}}" width="50" height="50" alt="">
                                </td>
                                <td>
                                    <a href="{{route('admin.services.edit',$service->uuid)}}" class="btn btn-primary btn-sm ">Edit <i class="fa fa-edit"></i> </a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
